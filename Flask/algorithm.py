...
def cmpEvent(timeStringTupleOne, timeStringTupleTwo):
    dateTimeTupleOne = ("","")
    dateTimeTupleTwo = ("", "")
    dateTimeTupleOne = (datetime.strptime(timeStringTupleOne[0] ,"%Y-%m-%dT%H:%M"), datetime.strptime(timeStringTupleOne[1] , "%Y-%m-%dT%H:%M"))
    dateTimeTupleTwo = (datetime.strptime(timeStringTupleTwo[0] , "%Y-%m-%dT%H:%M"), datetime.strptime(timeStringTupleTwo[1] , "%Y-%m-%dT%H:%M"))
...
def stringToDatetime(time_list):
  ...
  for timeTuple in time_list:
    timetuple = (datetime.strptime(timeTuple[0] , "%Y-%m-%dT%H:%M"), datetime.strptime(timeTuple[1] , "%Y-%m-%dT%H:%M"))
